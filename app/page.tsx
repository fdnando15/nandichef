            ...
            return (
              ...
              >
                <div className="flex gap-4">
                  {/* Product image */}
                  <div className="w-24 h-24 relative rounded-lg flex-shrink-0 overflow-hidden bg-white">
                    <Image
                      src={item.image}
                      alt={item.name}
                      fill
      ...
      <section className="py-16 bg-gradient-to-r from-nandi-primary to-nandi-accent">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <p className="text-white/90 text-lg mb-8">
            Contacta con nosotros por Teléfono/Whatsapp y prepararemos tu pedido
          </p>
          <a
